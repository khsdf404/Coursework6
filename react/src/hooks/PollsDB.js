...
const baseURL = 'http://192.168.74.57:8080';
...
class PollsDB {
    ...
    static async DeletePoll(link) {
        await PollsDB.CheckToken();
        return await PollsDB.Request(`${baseURL}/api/polls/${link}/`, 'DELETE', null, LocalStorage.GetToken());
    }
    static async PostPoll(obj) {
        await PollsDB.CheckToken();
        console.log(LocalStorage.GetToken())
        return await PollsDB.Request(`${baseURL}/api/polls/`, 'POST', obj, LocalStorage.GetToken());
    }

    static async GetUserPolls() {
        await PollsDB.CheckToken();
        return await PollsDB.Request(`${baseURL}/api/polls/all/`, 'GET', null, LocalStorage.GetToken());
    }
    ...
    static async CheckToken() {
        let tokenObj = await PollsDB.Request(`${baseURL}/auth/token/`, 'GET', null, LocalStorage.GetToken());
